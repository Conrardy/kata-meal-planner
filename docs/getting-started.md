...
Pour plus de détails, voir [Structure du Code](architecture/codebase-structure.md).
...
| Ressource | Lien |
|-----------|------|
| Endpoints API | [Référence complète](api/endpoints.md) |
| Architecture des flux | [Flux Frontend → API → Handlers](api/architecture.md) |
| Conventions Backend | [Conventions .NET](conventions/backend.md) |
| Conventions Frontend | [Conventions Angular](conventions/frontend.md) |
| Design System | [Design & Tailwind](conventions/design.md) |
| Deployment | [Docker & CI/CD](deployment/deployment.md) |
