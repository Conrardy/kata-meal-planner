...
- Module-specific testing patterns live in @docs/conventions/backend.md and @docs/conventions/frontend.md.
...
- CI hooks are not defined here; keep execution steps aligned with @docs/conventions/coding-assertions.md.
