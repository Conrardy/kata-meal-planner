...
| `sub-agents` | [checker.md](/aidd/prompts/templates/sub-agents/checker.md) |
| `sub-agents` | [dev.md](/aidd/prompts/templates/sub-agents/dev.md) |
| `sub-agents` | [memory-manager.md](/aidd/prompts/templates/sub-agents/memory-manager.md) |
